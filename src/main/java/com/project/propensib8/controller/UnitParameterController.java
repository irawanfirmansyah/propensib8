...
public class UnitParameterController {
	...
	public ResponseEntity<?> createUnitParameter(@Valid @RequestBody Map<String, String> res)
	...
	public ResponseEntity<?> getDetailPerforma(@PathVariable("namaUnit") String namaUnit,
		...
		Date tanggalSelesai = Date.valueOf(tanggalSelesais);
		detailPerforma
				.setReviewRest(reviewService.createReviewRest(namaUnit, tanggalMulai, tanggalSelesai, tipeSurvei));
		detailPerforma.setKomplainRest(
